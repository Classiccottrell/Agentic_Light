...
Source: https://www.w3.org/TR/2024/REC-WCAG22-20241212/
(latest version: https://www.w3.org/TR/WCAG22/)
...
from or derived from "Web Content Accessibility Guidelines (WCAG) 2.2",
https://www.w3.org/TR/2024/REC-WCAG22-20241212/.

This document is NOT covered by the MIT license applying elsewhere in this
skill directory. It remains W3C-copyrighted material. Converted to Markdown
from the source HTML; no normative text was altered. See
skills/wcag-audit/NOTICE (vendored from https://github.com/84emllc/claude-wcag-skill
@ commit 792755f).
-->
