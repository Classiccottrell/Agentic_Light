...
description: "Finds and inspects data assets within Google Cloud (BigQuery datasets/tables/views, BigLake catalogs, Spanner instances/databases/tables, etc.). Use when finding, exploring, or inspecting GCP data assets; retrieving schema, metadata, or governance policies for a GCP data asset; searching by keyword or topic without a known table or resource ID; or in place of `bq ls`. Don't use when assets are outside Google Cloud."
license: Apache-2.0
metadata:
  version: v4
  publisher: google
