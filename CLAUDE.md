...
- `python3 System_Config/test_context_catalog.py`, `python3 System_Config/test_context_curate.py`, `python3 System_Config/test_context_layer.py`, `python3 System_Config/test_context_packet_profiles.py`, `python3 System_Config/test_context_search.py` — context-layer fixture tests, run each separately: record validation/catalog, curation, end-to-end layer (links, FTS, profiles, stale embeddings, Ollama absence, byte caps, raw-source immutability), profile-scoped packets, and lexical search.
